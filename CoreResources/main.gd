...
@onready var daytimer = get_tree().get_first_node_in_group("DayTimer")
@onready var dayover_UI = UI.get_node("/root/UI/DayOverUI")
@onready var dayover_background = UI.get_node("/root/UI/DayOverUI/ColorRect")
@onready var dayover_button = UI.get_node("/root/UI/DayOverUI/NextDay")

func _ready():
	UI.get_node("/root/UI/DayOverUI/NextDay").pressed.connect(_on_next_day_pressed)
